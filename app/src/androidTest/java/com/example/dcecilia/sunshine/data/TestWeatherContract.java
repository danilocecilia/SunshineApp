...
import com.example.dcecilia.sunshine.data.WeatherContract;
...
public class TestWeatherContract extends AndroidTestCase {
    ...
    */
    public void testBuildWeatherLocation() {
        ...
        assertEquals("Error: Weather location Uri doesn't match our expected result", locationUri.toString(), "content://com.example.dcecilia.sunshine/weather/%2FNorth%20Pole");
    }
}